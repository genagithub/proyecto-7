...
app.layout = html.Div(id="body",className="e7_body",children=[
        html.A(href="https://github.com/genagithub/proyecto-7/blob/main/estimaci%C3%B3n_de_valores_inmobiliarios_y_segmentaci%C3%B3n_de_rangos.ipynb",target="blank",children=[html.H1("Análsis inmobiliario en California",id="title",className="e7_title")]),
